...
public class Phone implements Serializable {
    ...
    private String note;
    //приоритет
    private int proiritet;
    //кнопки изменить и удалить
    private int Change;
    private int Deleted;

    public Phone(String name, Calendar company, String note, int proiritet, int Chenge, int Deleted){

        this.name=name;
        this.company = company;
        this.note=note;
        this.proiritet= proiritet;
    ...
    public int getProiritet() {
        return this.proiritet;
    }
    public void setProiritet(int proiritet) {
        this.proiritet = proiritet;
    }
