    ...
    <body>
        ...
        <form class="autoriz" action="reg.php" method="post">
            <h1>Регистрация</h1>
                    ...
                    <input type="text" autocomplete="off" class="form-control" name="name" id="name" placeholder="Введите имя" required><br>
                    <input type="text" autocomplete="off" class="form-control" name="famile" id="famile" placeholder="Введите фамилию" required><br>
                    <input type="email" autocomplete="off" class="form-control" name="email" id="email" placeholder="Введите почту" required><br>
            ...
            <br>
                    <? switch($error){
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            echo "<br> Недопустимая длина фамилии!";
                            break;
                        case 5:
